...
Productivity helpers for roadmap/spec-driven work in `living-doc-collector-ad`. This set is
copied from the ecosystem **reference copy** in `living-doc-collector-gh` and adapted for
this repo's layout (the mock/fixture table, the doc paths).
...
| `rules/docs-lifecycle.md` | rule | Implemented prospective-spec sections **move** into the live docs. |
...
The mock/fixture cheat-table has one home — `agents/test-author.md`; `sdet.agent.md` only
points to it.
